...
procedure TForm6.startClick(Sender: TObject);
begin
gameBerakhir := False;   // tambahan untuk jalur
  mobil.Top := 204;
  mobil.Left := 430;
...
procedure TForm6.keluarClick(Sender: TObject);
var
  Res: Integer;
begin
...
procedure TForm6.mulailagiClick(Sender: TObject);
var i: Integer;
begin
gameBerakhir := False;   // tambahan untuk jalur
  // Reset posisi mobil
...
procedure TForm6.PanelLulusClick(Sender: TObject);
begin
...
function TForm6.IsOnTrack(const Rect: TRect): Boolean;     // tambahan untuk jalur
var
  i: Integer;
begin
  Result := False;
...
procedure TForm6.CekTabrakanDanSembunyikan(Diamond: TImage);
begin
...
procedure TForm6.CekKemenangan;
begin
  if Score >= 6 then
  begin
    Timer1.Enabled := False;
...
procedure TForm6.TimermobilTimer(Sender: TObject);      // tambahan untuk jalur agar jalan mobil bisa otomatis
var
  lampumerah: Boolean;
...
begin
  ...
  case ArahGerak of
    VK_LEFT:
    begin
      mobil.Picture.LoadFromFile('MobilPutihKiri.png');
      mobil.Width := 30;
      mobil.Height := 30;
    end;
    VK_RIGHT:
    begin
     mobil.Picture.LoadFromFile('MobilPutihKanan.png');
     mobil.Width := 30;
     mobil.Height := 30;
    end;
    VK_UP:
    begin
     mobil.Picture.LoadFromFile('MobilPutih.png');
     mobil.Width := 30;
     mobil.Height := 30;
    end;
    VK_DOWN:
    begin
    mobil.Picture.LoadFromFile('MobilPutihBawah.png');
    mobil.Width := 30;
    mobil.Height := 30;
    end;
  end;
...
procedure TForm6.SetPalang(Palang: TImage; Buka: Boolean);
begin
...
procedure TForm6.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);     // form key di update sebagian code di pindahkan ke dalam timer mobil
var
  i: Integer;
  diJalur: Boolean;
begin
