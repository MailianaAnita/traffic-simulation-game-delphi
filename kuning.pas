...
procedure TForm5.mulailagiClick(Sender: TObject);
var i: Integer;
begin
gameBerakhir := False;   // tambahan untuk jalur
  // Reset posisi mobil
...
function TForm5.IsOnTrack(const Rect: TRect): Boolean;     // tambahan untuk jalur
var
  i: Integer;
begin
  Result := False;
...
procedure TForm5.CekTabrakanDanSembunyikan(Diamond: TImage);
begin
...
procedure TForm5.CekKemenangan;
begin
  if Score >= 6 then
  begin
    Timer1.Enabled := False;
...
procedure TForm5.TimermobilTimer(Sender: TObject);      // tambahan untuk jalur agar jalan mobil bisa otomatis
var
  lampumerah: Boolean;
...
begin
  ...
  case ArahGerak of
    VK_LEFT:
    begin
      mobil.Picture.LoadFromFile('MobilKuningKiri.png');
      mobil.Width := 30;
      mobil.Height := 30;
    end;
    VK_RIGHT:
    begin
     mobil.Picture.LoadFromFile('MobilKuningKanan.png');
     mobil.Width := 30;
     mobil.Height := 30;
    end;
    VK_UP:
    begin
     mobil.Picture.LoadFromFile('MobilKuning.png');
     mobil.Width := 30;
     mobil.Height := 30;
    end;
    VK_DOWN:
    begin
    mobil.Picture.LoadFromFile('MobilKuningBawah.png');
    mobil.Width := 30;
    mobil.Height := 30;
    end;
  end;
...
procedure TForm5.SetPalang(Palang: TImage; Buka: Boolean);
begin
...
procedure TForm5.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);     // form key di update sebagian code di pindahkan ke dalam timer mobil
var
  i: Integer;
  diJalur: Boolean;
begin
